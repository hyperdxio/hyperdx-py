...
from hyperdx.opentelemetry.sampler import (
    configure_sampler,
...
def test_sampler_with_rate_of_one_is_ALWAYS_ON_and_recorded():
    sample_rate_one = HyperDXOptions(sample_rate=1)
...
def test_sampler_with_rate_of_zero_is_ALWAYS_OFF_and_DROP():
    sample_rate_zero = HyperDXOptions(sample_rate=0)
...
def test_sampler_with_rate_of_ten_configures_TraceIdRatioBased():
    sample_rate_ten = HyperDXOptions(sample_rate=10)
