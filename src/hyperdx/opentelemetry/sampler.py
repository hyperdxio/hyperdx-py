...
from hyperdx.opentelemetry.options import DEFAULT_SAMPLE_RATE, HyperDXOptions
...
def configure_sampler(
    ...
    configured based on the sample_rate determined in HyperDXOptions.
    ...
    Args:
        options (HyperDXOptions): the HyperDXOptions containing
